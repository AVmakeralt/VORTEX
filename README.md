...
Guard failure and retracing, failed guards feed into the trace re-tracing system, which generates a new specialized variant

Code installation, compiled code is installed in the code cache via vtx_install_method
...
Per-method failure tracking, a hash table records guard failures per method
...
Maximum attempts, 5 re-traces per method before giving up
