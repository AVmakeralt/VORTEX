...
int main(void) {
    ...
    config.run_gvn = false; config.run_sccp = false; config.run_dce = false; config.run_licm = false; config.run_bounds_check = false; config.run_pea = false; config.run_inlining = false; config.run_loop_spec = false; config.run_vectorize = false;
