...
- **JS Source Reading**: Analyze the reproducing CPP script to identify language
...
- **Spec Exploration**: Use your internal knowledge to start reading relevant
  V8 C++ code (via `code_search`)
- **Work Branching**: PROACTIVELY spawn subagents for every
